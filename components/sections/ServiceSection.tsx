import { Check, Wifi, BatteryMedium, ArrowUp, Zap, MessageCircle } from "lucide-react";
...
export function ServiceSection() {
  ...
  return (
    <section id="service" className="bg-anset-cream relative overflow-hidden border-t border-anset-blue/10">
      ...
      <div className="container-anset py-16 md:py-20 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-5">
          <div className="bg-white rounded-[20px] border border-anset-blue/8 overflow-hidden flex flex-col">
          ...
          <div className="bg-gradient-to-br from-anset-lilas-soft to-anset-lilas-soft/40 rounded-[20px] border border-anset-blue/8 p-6 flex flex-col items-center justify-center relative overflow-hidden min-h-[420px]">
            <p className="absolute top-4 left-4 text-[10px] font-black uppercase tracking-[1.8px] text-anset-lilas z-10">
              {ai.tag}
            </p>

            <div className="bg-[#1a1a1c] rounded-[22px] p-1.5 w-[200px] shadow-[0_18px_50px_rgba(82,63,102,0.32)] relative z-10">
              <div className="bg-anset-cream rounded-[17px] overflow-hidden relative flex flex-col h-[330px]">
                ...
                <div className="px-3 pb-2.5 pt-2 border-b border-anset-blue/8 flex items-center gap-2">
                  <div className="w-[30px] h-[30px] rounded-full bg-gradient-to-br from-anset-lilas to-anset-lilas-dark text-white flex items-center justify-center text-xs font-black tracking-tight relative">
                    A
                    <span className="absolute -bottom-0.5 -right-0.5 w-2 h-2 rounded-full bg-anset-menthe border-[1.5px] border-anset-cream" aria-hidden="true" />
                  </div>
                ...
                <div className="flex-1 px-3 py-2.5 flex flex-col gap-1.5 bg-gradient-to-b from-anset-cream to-anset-mist overflow-hidden">
                  {sample.messages.map((msg, idx) => (
                    <div
                      key={idx}
                      className={`text-[9px] leading-tight px-2 py-1.5 rounded-[11px] max-w-[78%] font-medium ${
                        msg.from === "user"
                ...
                <div className="px-2.5 py-1.5 border-t border-anset-blue/8 flex gap-1.5 bg-anset-cream items-center">
            ...
            <div className="flex gap-1.5 mt-4 flex-wrap justify-center">
              <span className="bg-white/85 text-anset-lilas text-[9px] font-black px-2.5 py-1.5 rounded-full flex items-center gap-1 border border-anset-lilas/20">
                <Zap className="w-2.5 h-2.5" aria-hidden="true" />
                24h/24
              </span>
              <span className="bg-white/85 text-anset-lilas text-[9px] font-black px-2.5 py-1.5 rounded-full flex items-center gap-1 border border-anset-lilas/20">
                <MessageCircle className="w-2.5 h-2.5" aria-hidden="true" />
                Live au lancement
              </span>
            </div>
          </div>
