import { Car, Home, ShieldPlus } from "lucide-react";
...
export function RoadmapSection() {
  return (
    <section className="bg-anset-cream border-t border-anset-blue/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {ROADMAP.map((r) => {
            ...
            return (
              <div
                key={r.slug}
                className="bg-white rounded-2xl p-4 flex items-center gap-3 border border-anset-blue/8"
              >
                <div className="w-10 h-10 rounded-full bg-anset-cream border-[1.5px] border-anset-blue/15 flex items-center justify-center flex-shrink-0">
